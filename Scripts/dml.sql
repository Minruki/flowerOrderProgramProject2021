...
values ('lys6009', '이용수', '010-1234-5678', 1000000, '소나무'),
       ...
       ('Minruki', '이민정', '010-7619-1679', 115000, '꽃봉오리'),
   	   ('lee.daeung', '이대응', '010-5678-1234',10000, '새싹'),
   	   ('Taehoon1004', '갓태훈', '010-1004-1004',2000000, '소나무'),
   	   ('Butterfly', '이나비', '010-7777-6666', 500000, '꽃'),
   	   ('teacher', '선생님', '010-3416-4812', 100000, '꽃봉오리'),
   	   ('ABCDE', '알파벳', '010-1123-5211', 9000, '새싹'),
   	   ('JavaKim', '김자바', '010-5555-1111', 130000, '꽃봉오리'),
   	   ('Eclipse', '스윙스', '010-1416-9812', 100000, '꽃봉오리'),
   	   ('kingsurin', '짱수린', '010-6123-1004', 100000, '꽃봉오리'),
   	   ('cuteYejin', '김예진', '010-1991-5112', 100000, '꽃봉오리'),
   	   ('Captain7', '반장님', '010-6123-1032', 50000, '새싹');
...
-- 
delete from order_program where order_number = '00/0411';
