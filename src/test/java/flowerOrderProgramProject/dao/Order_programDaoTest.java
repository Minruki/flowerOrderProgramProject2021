...
public class Order_programDaoTest {
	...
	public void test01Insertorder_program() {
		...
		Order_program neworder_program = new Order_program(0, "0005", d ,new Customer_information("yjw6101"), new Flower_information("A002"), 2, "꽃바구니", 0);
	...
	public void test02Updateorder_program() {
		...
		Order_program neworder_program = new Order_program(0, "0007", d ,new Customer_information("yjw6101"), new Flower_information("A002"), 3, "꽃다발", 0);
	...
	public void test03Deleteorder_programByNo() {
		...
		Order_program Deleteorder_program = new Order_program(new Customer_information("yjw6101"));
