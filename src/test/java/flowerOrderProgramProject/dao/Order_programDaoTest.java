...
public class Order_programDaoTest {
	...
	public void test05Selectorder_programByNo() {
		...
		Order_program order = new Order_program("lys6009");
	...
	public void test01Insertorder_program() {
		...
		Order_program neworder_program = new Order_program(0, "0005", d ,"yjw6101", "A002", 2, "꽃바구니", 0);
	...
	public void test02Updateorder_program() {
		...
		Order_program neworder_program = new Order_program(0, "0007", d ,"yjw6101", "A002", 3, "꽃다발", 0);
	...
	public void test03Deleteorder_programByNo() {
		...
		Order_program Deleteorder_program = new Order_program("yjw6101");
